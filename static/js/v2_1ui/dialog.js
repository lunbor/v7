...
v.load('popbox.js', function () {
    if (v.AlertBox)
        return;
    // alert,全局唯一
    // 依赖于 v.PopBox
    v.AlertBox = v.extend(v.PopBox, function (self) {

        self.anchor = 'data-alertbox';
    ...
    // confirm,全局唯一
    // 依赖于 v.PopBox v.AlertBox
    v.ConfirmBox = v.extend(v.AlertBox, function (self) {

        self.anchor = 'data-confirmbox';
