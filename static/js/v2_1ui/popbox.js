 ...
 */
v.PopBox || (function () {
    v.PopBox = v.extend(v.UI, function (self) {
        // 静态属性
        self.anchor = 'data-popbox';
        ...
        var _initToggle = function () {
            var stimer;
            !this.toggle || $(this.tribox).on('click', this.toggle, function (event) {
                var tar = event.currentTarget;
                stimer = v.callst(function () {
        ...
        var _setPos = function () {
            if (this.position === 'middle') {
                ...
                $(this.anchor).animate({top: top, left: left}, this.speed);
                ...
                if ('left|right'.indexOf(pos) > -1) {
                    ...
                    top = rect[0];
                    $(this._arrow).animate({'top': rect[1]}, this.speed);
                    ...
                    left = rect[0];
                    $(this._arrow).animate({'left': rect[1]}, this.speed);
                }
        ...
        var _autoClose = function () {
            if (this.closesec > 0) {
                setTimeout(v.bind(this.close, this), this.closesec);
            }
        };
        ...
        this.construct = function (options) {
            ...
            // 关闭
            if (this.closel) {
                $(this.closel, this.anchor).on('click', v.bind(this.close, this));
            }
